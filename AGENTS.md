...
- 当前源码版本：Android 1.6.0-dev.20；Windows 接收端 1.6.0-dev.15（发布序号 27）；macOS 接收端预览 2.0.0-dev.3；iOS 尚待开发；上一实机稳定基线为 1.4.0。本机 Windows 已覆盖更新；Samsung 新版因预览签名不同，待用户选择安装通道，见 docs/PHONE_MANAGED_DESKTOP.md。
...
- 局域网入口必须继续独立使用 HTTPS 8766、USB 配对密钥、证书固定与目标 ID 校验。
